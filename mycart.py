...
def render_cart_page():
    ...
    for item in items:
        ...
        with col2:
            # FIX #4: all values are plain strings — no HTML leaking through
            ...
            # Strip any accidental HTML from description
            ...
            # Use native st.markdown — no unsafe_allow_html needed
            ...
            elif not seller_shipped and not buyer_received:
                ...
                with b2:
                    if st.button("✅ Received Item", key=f"received_{item_id}"):
                        ...
                        if result.get("success"):
                            ...
                            # FIX #6 + #7: trigger balloons + congrats dialog
                            st.balloons()
