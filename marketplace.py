...
def render_marketplace_page():
    ...
    .mp-card {
        ...
        box-shadow:0 1px 3px rgba(0,0,0,.06); padding:16px; margin-bottom:12px;
    }
    .mp-card-title {
    ...
    # Client-side filters (Normalizing Penang / Pulau Pinang database variance)
        ...
        with cols[idx % 3]:
            ...
            if img_url:
                ...
                st.markdown(
                    ...
                    "color:#86efac;font-size:2rem;margin-bottom:8px'>📦</div>",
                    unsafe_allow_html=True,
                )

            # ── 2. Structural Row String Formats ──
            ...
            # ── 3. Clean Card Body HTML (Flush strings remove render formatting bugs) ──
            card_html = f"""<div class="mp-card">
